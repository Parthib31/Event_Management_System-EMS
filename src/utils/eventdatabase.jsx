export let eventList = [
  ...
  },
  {
    ...
    startDate: "05/06/2002",
    endDate: "12/06/2002",
    location: "Netaji Bhavan",
    description:
  ...
  },
  {
    ...
    location: "Netaji Bhavan",
    description:
      "'Robothon' is an exhilarating college event where students showcase their prowess in robotics. Participants will engage in various competitions, demonstrations, and workshops, highlighting innovation and creativity. From autonomous robots to intricate mechanical designs, attendees will witness the future of technology in action. Experts and enthusiasts alike will gather to exchange ideas and push the boundaries of robotics. With hands-on activities and insightful discussions, Robothon promises an immersive experience for all attendees. Join us for a day filled with excitement, learning, and inspiration. Don't miss your chance to be part of this groundbreaking event!",
    img: "https://images.unsplash.com/photo-1612036782180-6f0b6cd846fe?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8M3x8Y29taWNzfGVufDB8fDB8fHww",
  }
];

export const updateEventList = (updatedEventList) => {
  eventList = updatedEventList;
};

export let registeredEvents = [
  
];

export const updateRegisteredEvents = (updated) => {
